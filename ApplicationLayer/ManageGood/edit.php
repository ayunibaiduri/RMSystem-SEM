...
<body>
  <div class="wrapper" id="wrapper">
    ...
    <div style="background-image: url('../../img/goodList.jpg');">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="bradcaump__inner text-center">
              ...
              <nav class="bradcaump-inner">
                <a class="breadcrumb-item" href="../../ApplicationLayer/ManageLogin/index.php">Good List</a>
...
<section class="type__category__area bg--white section-padding">
    <div style="background-image: url('../../img/goodMenu.jpg');">
    ...
    <div class="card card-5">
      ...
      <div class="card-body">
        <form action="" method="POST">
          ...
          foreach($data as $row){
            ?>
            <center><img src="../../img/<?php echo $row['good_image'];?>" height="130" width="150"></center>            
            <div class='form-row'>
